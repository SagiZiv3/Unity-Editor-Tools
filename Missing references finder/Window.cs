    ...
    internal class Window : EditorWindow
    {
        ...
        private void DisplayNamespaceTextFieldAndRemoveButton(ref int i, float width)
        {
            ...
            if (GUILayout.Button("-", GUILayout.Width(25f)))
            {
                ...
                UpdateNamespacesToIgnoreEditorPrefs();
                i--;
            }
            GUILayout.EndHorizontal();
        }
        ...
        private void UpdateNamespacesToIgnoreEditorPrefs()
        {
            EditorPrefs.SetString("EditorTools.MissingReferencesFinder.NamespaceToIgnore",
                string.Join(";", namespacesToIgnore));
        }
